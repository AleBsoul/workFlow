    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_candidato', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='polls.candidato')),
                ('id_datore', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='polls.datore')),
            ],
        ),
        migrations.CreateModel(
            name='Offerta',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_candidato', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='polls.candidato')),
                ('id_offerta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='polls.offerta')),
            ],
        ),
    ]
